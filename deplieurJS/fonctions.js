...
function couleurFr(cn){
	const couleurs =[
["Default", "noir", [0,0,0], ""],
["White", "blanc", [255,255,255], "256_256_256"],
...
["Tan", "brun tané", [210,180,140], "256_204_128"],
...
["Maroon", "marron", [128,0,0], "163_102_000"],
...
["Red", "rouge", [255,0,0], "163_000_000"],
["FireBrick", "rouge brique", [178,34,34], ""],
["DarkRed", "rouge sombre", [139,0,0], ""],
["Pink", "rose", [255,192,203], "254_204_256"],
...
["Orange", "orange", [255,165,0], "256_051_000"],
["Gold", "or", [255,215,0], "256_204_000"],
["Yellow", "jaune", [255,255,0], "256_256_001"],
["LightYellow", "jaune clair", [255,255,224], "254_256_153"],
...
["Violet", "parme", [238,130,238], "112_102_204"],
...
["LightGreen", "vert clair", [144,238,144], "204_256_204"],
...
["Green", "vert", [0,255,0], "000_153_000"],
["DarkGreen", "vert sombre", [0,100,0], "000_102_000"],
...
["Aqua", "eau", [0,255,255], "153_214_256"],
["Cyan", "cyan", [0,255,255], ""],
...
["LightBlue", "bleu clair", [173,216,230], "204_256_256"],
...
["Blue", "bleu", [0,0,255], "000_051_153"],
["MediumBlue", "bleu moyen", [0,0,205], ""],
["DarkBlue", "bleu sombre", [0,0,139], "051_051_112"],
["Navy", "bleu marine", [0,0,128], ""],
["MidnightBlue", "bleu nuit", [25,25,112], ""]
]

cn = cn.toLowerCase()
if (cn.startsWith("couleur_")) {
	cn = cn.replace("couleur_", "")	
	i = couleurs.findIndex(c => c[3] === cn)
} else {
	i = couleurs.findIndex(c => c[0].toLowerCase() === cn)
}

return i === -1 ? {n:'?', v:[0,0,0]} : {c:couleurs[i][0], n:couleurs[i][1], v:couleurs[i][2]}
}
